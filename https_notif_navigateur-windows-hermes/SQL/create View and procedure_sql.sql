...
-- si on filtre que par Agent (exemple, WHERE Agent = 0)
CREATE NONCLUSTERED INDEX FIMAINFO_IDX_Agent
ON dbo.Fimainfo_C4_notif_son_details_appels (Agent);
GO

-- si on filtre que par Id
CREATE NONCLUSTERED INDEX FIMAINFO_IDX_Id
ON dbo.Fimainfo_C4_notif_son_details_appels (Id);
GO

-- si on filtre que par TelClient et puis par Agent
CREATE NONCLUSTERED INDEX FIMAINFO_IDX_TelClient_CallLocalTime
ON dbo.Fimainfo_C4_notif_son_details_appels (TelClient, CallLocalTime);
GO

-- si on filtre par Id et puis par Agent
CREATE NONCLUSTERED INDEX FIMAINFO_IDX_Id_Agent
ON dbo.Fimainfo_C4_notif_son_details_appels (Id, Agent);
GO

-- si on filtre par Agent et puis par Id 
CREATE NONCLUSTERED INDEX FIMAINFO_IDX_Agent_Id
ON dbo.Fimainfo_C4_notif_son_details_appels (Agent, Id);
GO
